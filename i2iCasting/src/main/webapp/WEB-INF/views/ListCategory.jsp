						...
						<c:forEach items="${PList}" var="product">
							<div class="col-md-5 col-sm-12 col-xs-12">
								<div class="product-image">
									...
									<a href="ShowProduct/${product.id}"> <img
										src="<c:url value="/resources/images/${product.id}.jpg"  class="img-responsive rotprod"></c:url>"></a>
							...
							<div class="col-md-7 col-sm-12 col-xs-12">
								...
								<div class="product-info smart-form">
									<div class="row">
										<div class="col-md-12">
											<a href="addToCart/{id}" class="btn btn-danger btn-cart"><span>Add
													to cart</span></a> <a href="#" class="btn btn-info"><span>More
													info</span></a>
										</div>
										<div class="col-md-12">
											<div class="rating">
